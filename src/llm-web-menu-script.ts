 ...
 * selection + chosen label into `window.__mvAideLlmMenu.pendingInvoke`. The
...
const WEB_MENU_STATE_KEY = "__mvAideLlmMenu";
    ...
    try {
      ...
      const onContextMenu = (event) => {
        try {
          ...
          menuEl.setAttribute("data-mv-aide-llm-menu", "true");
...
export const WEB_DISMISS_STATE_KEY = "__mvAideLlmDismiss";
    ...
    try {
      ...
      const onPointerDown = (event) => {
        try {
          ...
          const menu = document.querySelector('[data-mv-aide-llm-menu="true"]');
...
export const WEB_HOTKEY_STATE_KEY = "__mvAideLlmHotkey";
