...
export const DEFAULT_INLINE_REJECT_PROMPT =
  ...
  "不要续写、复用、扩展或轻微改写被拒绝候选；如果没有明显更好的替代，请只输出 <MV_AIDE_NO_COMPLETION>。\n" +
  "被拒绝候选如下，仅用于避开：\n<rejected_completion>\n{rejected}\n</rejected_completion>";
...
export const DEFAULT_SETTINGS = {
  ...
  terminalOpenPosition: "right" as const,
  terminalOpenMode: "split" as const,
