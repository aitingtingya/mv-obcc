  ...
  groups: [
    {
      ...
      capabilities: [
        ...
        capability("virtual-replace", "Virtual Replace mode", ["gR"]),
        capability("select", "Character, line and block Select", ["gh", "gH", "g<C-h>", "<C-g>"]),
        capability("temporary-normal", "One Normal command from Insert", ["<C-o>"]),
